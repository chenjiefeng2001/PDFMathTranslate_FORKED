...
class TestCollisionEngine(unittest.TestCase):
    def test_no_collisions(self):
        ...
        nodes = [DocumentNode(id="a", node_type=NodeType.PARAGRAPH, bbox=(0, 0, 50, 50), text="x"),
                 DocumentNode(id="b", node_type=NodeType.PARAGRAPH, bbox=(100, 0, 150, 50), text="y")]
        self.assertEqual(len(CollisionEngine.detect(nodes)), 0)

    def test_overlap_detected(self):
        from pdf2zh.v3.layout import CollisionEngine
        nodes = [DocumentNode(id="a", node_type=NodeType.PARAGRAPH, bbox=(0, 0, 100, 100), text="x"),
                 DocumentNode(id="b", node_type=NodeType.PARAGRAPH, bbox=(50, 50, 150, 150), text="y")]
