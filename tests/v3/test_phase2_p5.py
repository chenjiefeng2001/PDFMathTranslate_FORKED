...
class TestMemoryGraph(unittest.TestCase):
    ...
    def test_contains(self):
        mg = MemoryGraph()
        mg.put("k", "v")
        self.assertTrue(mg.contains("k"))
        self.assertFalse(mg.contains("x"))

    def test_remove(self):
        mg = MemoryGraph()
        mg.put("k", "v")
        self.assertTrue(mg.remove("k"))
        self.assertFalse(mg.contains("k"))
...
class TestCacheGraph(unittest.TestCase):
    ...
    def test_contains(self):
        cg = CacheGraph()
        cg.put("k", "v")
        self.assertTrue(cg.contains("k"))
        self.assertFalse(cg.contains("x"))

    def test_remove(self):
        cg = CacheGraph()
        cg.put("k", "v")
        self.assertTrue(cg.remove("k"))
        self.assertFalse(cg.contains("k"))
    ...
    def test_eviction(self):
        ...
        cg.put("b", 2)
        cg.put("c", 3)
        self.assertFalse(cg.contains("a"))
        self.assertTrue(cg.contains("c"))
    ...
    def test_hits(self):
        ...
        cg.get("k")
        cg.get("k")
        self.assertEqual(cg.hits, 2)

    def test_size_property(self):
        cg = CacheGraph()
        self.assertEqual(cg.size, 0)
        cg.put("a", 1)
        self.assertEqual(cg.size, 1)
...
class TestPersistentGraph(unittest.TestCase):
    ...
    def test_get_missing(self):
        self.assertIsNone(self.pg.get("x"))

    def test_contains(self):
        self.pg.put("k", "v")
        self.assertTrue(self.pg.contains("k"))
        self.assertFalse(self.pg.contains("x"))

    def test_remove(self):
        self.pg.put("k", "v")
        self.assertTrue(self.pg.remove("k"))
    ...
    def test_clear(self):
        ...
        self.pg.put("b", 2)
        self.pg.clear()
        self.assertEqual(self.pg.size, 0)

    def test_size(self):
        self.assertEqual(self.pg.size, 0)
        self.pg.put("a", 1)
        self.assertEqual(self.pg.size, 1)
    ...
    def test_meta_missing(self):
        self.assertIsNone(self.pg.get_meta("x", "y"))
    ...
    def test_hits(self):
        self.pg.put("k", "v")
        self.pg.get("k")
        self.assertEqual(self.pg.hits, 1)


@unittest.skipIf(not _HAS_V3, "V3 not importable")
class TestStorageRuntime(unittest.TestCase):
    def setUp(self):
        self.sr = StorageRuntime()
    ...
    def test_load_missing(self):
        self.assertIsNone(self.sr.load("x"))

    def test_contains(self):
        self.sr.save("k", "v")
        self.assertTrue(self.sr.contains("k"))
        self.assertFalse(self.sr.contains("x"))

    def test_remove(self):
        self.sr.save("k", "v")
        self.assertTrue(self.sr.remove("k"))
    ...
    def test_clear(self):
        ...
        self.sr.save("b", 2)
        self.sr.clear()
        self.assertFalse(self.sr.contains("a"))

    def test_clear_memory(self):
        self.sr.save("k", "v")
        self.sr.clear_memory()
