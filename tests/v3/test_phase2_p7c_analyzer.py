...
class TestSemanticAnalyzer(unittest.TestCase):
    def setUp(self):
        ...
        self.g.add_node(
            DocumentNode("p1", NodeType.PARAGRAPH, (50, 50, 500, 70), text="para1")
        )
    ...
    def test_analyze_caption(self):
        ...
        g.add_node(
            DocumentNode(
                "c1", NodeType.PARAGRAPH, (50, 50, 500, 65), text="Figure 1: test"
            )
        )
        self.ana.analyze(g)
    ...
    def test_analyze_formula(self):
        g = DocumentGraph()
        g.add_node(
            DocumentNode("f1", NodeType.PARAGRAPH, (50, 50, 500, 80), text="y = mx + b")
        )
        self.ana.analyze(g)
