...
Provides PDF preview, result file selection, and download buttons.
...
def create_preview_panel() -> dict:
    ...
    with gr.Group():
        ...
        with gr.Row():
            result_files_dropdown = gr.Dropdown(
                choices=[],
                label="选择生成的文件 / Select Output",
                interactive=True,
    ...
    return {
        ...
        "result_files_dropdown": result_files_dropdown,
