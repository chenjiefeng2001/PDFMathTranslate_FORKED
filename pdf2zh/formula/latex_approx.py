...
_GREEK_LOWER = {
    ...
    "ϵ": "\\varepsilon", "ϑ": "\\vartheta", "ϖ": "\\varpi",
    "ϱ": "\\varrho", "ς": "\\varsigma", "ϕ": "\\varphi", "ϰ": "\\varkappa",
}
...
_OPERATORS = {
    "±": "\\pm", "∓": "\\mp", "×": "\\times", "÷": "\\div",
    "⋅": "\\cdot", "∙": "\\bullet", "∘": "\\circ", "∗": "\\ast",
    "⊕": "\\oplus", "⊗": "\\otimes", "⊙": "\\odot", "∧": "\\wedge",
    "∨": "\\vee", "∩": "\\cap", "∪": "\\cup", "⊓": "\\sqcap",
    "⊔": "\\sqcup", "⋆": "\\star", "·": "\\cdot",
}
...
_BIG_OPS = {
    "∑": "\\sum", "∏": "\\prod", "∐": "\\coprod", "∫": "\\int",
    "∬": "\\iint", "∭": "\\iiint", "∮": "\\oint", "⋂": "\\bigcap",
    "⋃": "\\bigcup", "⨁": "\\bigoplus", "⨂": "\\bigotimes",
    "⋀": "\\bigwedge", "⋁": "\\bigvee",
}
...
_LETTERLIKE = {
    ...
    "ℝ": "\\mathbb{R}", "ℂ": "\\mathbb{C}", "ℑ": "\\Im", "ℜ": "\\Re",
    "℘": "\\wp", "△": "\\triangle",
}
...
_KEEP_ASCII = set("()[],;:+-*/=<>!|.abcdefghijklmnopqrstuvwxyz"
                  "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'\"`")

_UNICODE_TO_LATEX: Dict[str, str] = {}
for _m in (_GREEK_LOWER, _GREEK_UPPER, _OPERATORS, _RELATIONS, _ARROWS,
           _BIG_OPS, _RADICALS, _LETTERLIKE, _SUPERSCRIPTS, _SUBSCRIPTS,
           _PUNCT, _LATEX_SPECIAL):
