...
class ResourceManager:
    ...
    def track(self, operation, elapsed, memory_delta=0):
        self._usage.append(
            ResourceUsage(
                operation=operation, elapsed=elapsed, memory_delta=memory_delta
            )
        )
    ...
    def get_resource_report(self):
        ...
        rpt.operation_counts = op_counts
        rpt.operation_times = op_times
...
class RuntimeSupervisor:
    ...
    def record_operation(self, operation, elapsed, success=True):
        ...
        if not success:
            self.resource_manager.track_error()
    ...
    def auto_diagnose(
        ...
        *,
        ...
        return self.diagnostic_graph.add_diagnostic(
            label=label,
            severity=severity,
            module=module,
            details=details,
    ...
    def auto_repair(self):
        ...
        for d in self.diagnostic_graph.get_unresolved():
            ...
            if result is not None:
                ...
                self.diagnostic_graph.mark_failed(d.id, "No strategy")
        return repaired
    ...
    def stats(self):
        ...
        return {
            ...
            "resources": {
                "total_ops": rpt.total_operations,
                "total_time": round(rpt.total_time, 3),
                "avg_time": round(rpt.avg_time, 4),
                "errors": rpt.error_count,
            },
            "recovery": {
                "strategies": len(self.recovery_manager._strategies),
                "history": len(self.recovery_manager.get_history()),
            },
            "diagnostic_graph": self.diagnostic_graph.stats(),
        }
