...
DEFAULT_GLOSSARIES: Dict[str, Dict[str, str]] = {
    "cs": {
        "kernel": "内核", "scheduler": "调度器", "thread": "线程",
        "process": "进程", "cache": "缓存", "buffer": "缓冲区",
        "compiler": "编译器", "runtime": "运行时", "stack": "栈",
        "heap": "堆", "deadlock": "死锁", "deadlock detection": "死锁检测",
        "garbage collector": "垃圾回收器", "instruction": "指令",
        "register": "寄存器", "scheduler": "调度器",
    },
    "math": {
        "field": "域", "ring": "环", "space": "空间", "group": "群",
        "manifold": "流形", "topology": "拓扑", "eigenvalue": "特征值",
        "eigenvector": "特征向量", "gradient": "梯度", "lemma": "引理",
        "corollary": "推论", "theorem": "定理",
    },
    "medicine": {
        "lesion": "病灶", "symptom": "症状", "biopsy": "活检",
        "morbidity": "发病率", "mortality": "死亡率", "prognosis": "预后",
        "pathogen": "病原体", "antibody": "抗体",
    },
    "law": {
        "plaintiff": "原告", "defendant": "被告", "jurisdiction": "管辖权",
        "statute": "法规", "precedent": "判例", "tort": "侵权",
    },
    "engineering": {
        "stress": "应力", "strain": "应变", "fatigue": "疲劳",
        "tolerance": "公差", "torque": "扭矩", "bearing": "轴承",
        "vibration": "振动", "damping": "阻尼",
    },
}

_DOMAIN_KEYWORDS = {
    "cs": ("kernel", "scheduler", "thread", "compiler", "runtime",
           "deadlock", "register", "instruction"),
    "math": ("lemma", "theorem", "eigenvalue", "manifold", "topology",
             "gradient", "vector space"),
    "medicine": ("lesion", "patient", "clinical", "biopsy", "antibody",
                 "symptom"),
    "law": ("plaintiff", "defendant", "statute", "jurisdiction",
            "contract", "liability"),
    "engineering": ("stress", "strain", "fatigue", "torque", "bearing",
                    "vibration", "tolerance"),
}
...
class DomainGlossary:
    ...
    def __init__(self, domains: Optional[List[str]] = None,
                 glossaries: Optional[Dict[str, Dict[str, str]]] = None) -> None:
