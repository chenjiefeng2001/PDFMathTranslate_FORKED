...
class PropertyGraph:
    ...
    def __init__(
        self, name: str = "property_graph", schema: Optional[PropertySchema] = None
    ) -> None:
        self.name = name
    ...
    def add_node(
        self, node_id: str, node_type: str = "Node", label: str = "", **props: Any
    ) -> dict:
        ...
        merged = {"id": node_id, "type": node_type, "label": label or node_id}
        merged.update(props)
    ...
    def upsert_node(
        self, node_id: str, node_type: Optional[str] = None, **props: Any
    ) -> dict:
    ...
    def add_edge(
        self, source: str, target: str, relation: str = "related", **props: Any
    ) -> PropertyEdge:
        ...
        edge = PropertyEdge(
            source=source, target=target, relation=relation, props=dict(props)
        )
    ...
    def neighbors(
        self, node_id: str, direction: str = "out", relation: Optional[str] = None
    ) -> Set[str]:
    ...
    @classmethod
    def from_dict(
        cls, data: dict, schema: Optional[PropertySchema] = None
    ) -> "PropertyGraph":
...
def create_property_graph_from_document(
    document_graph: Any, name: str = "doc_property"
) -> PropertyGraph:
