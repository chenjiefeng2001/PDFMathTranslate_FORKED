...
python -m pytest tests/ -q -p no:cacheprovider                → 1948 passed （v1.18 后合并：把离散 `test/` 目录 6 个用例并入 `tests/`，旧 1871 + 新增 77）
