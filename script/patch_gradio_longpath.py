...
"""
    ...
    if (
        "shutil.move(file, dest)" in content
        and "move_uploaded_files_to_cache" in content
    ):
        print(
            "WARNING: Could not match function signature exactly. Trying regex replacement..."
        )
        import re
