...
Get-ChildItem -Path $ProjectRoot -Exclude ".git", ".idea", ".venv", "__pycache__", ".mypy_cache", ".pytest_cache", "node_modules", "script" | Copy-Item -Destination $DepBuildDir -Recurse -Force
